...
- **📏 한글 글꼴 실폭으로 조판을 재현합니다**: 한컴돋움·HY견고딕·휴먼명조 등 8종의 실제 글자 폭으로 줄바꿈을 계산해(한글 2024 PDF 154줄 전부 일치), 짧은 꼬리 줄은 자간으로 올리고 긴 어절이 넘어가 공백이 크게 벌어지는 줄은 자간을 살짝 줄여 메웁니다. 종전처럼 한 줄을 과하게 눌러 옆 줄과 밀도가 달라 보이는 일이 줄었습니다.
